...
class Box:
    ...
    def __init__(self, width: pint.Quantity, depth: pint.Quantity, height: pint.Quantity):
        ...
        self.area = 2 * (self.width * self.depth + self.depth * self.height + self.height * self.width)
